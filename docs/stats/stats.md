...
- [Binomial Test](./binomial-test.md)

## Analyzing Two Categorical Variables

- [Odds](./odds.md)
- [Risk/Odds Ratio](./odds-ratio-risk.md)
- [Fisher's Exact Test](./fisher-test.md)
- [Chi-Square Test](./chi-square.md)

## Analyzing One Numeric Variable

- [One Sample T-Test](./one-t-test.md)
